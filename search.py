...
def ramificacion_y_acotacion(problem, fringe):
    """Search through the successors of a problem to find a goal.
    The argument fringe should be an empty queue.
...
def problema_ramificacion_y_acotacion(problem):
    """Search the shallowest nodes in the search tree first. [p 74]"""
    return ramificacion_y_acotacion(problem, SortedQueue())


def ramificacion_y_acotacion_conH(problem, fringe):
    """Search through the successors of a problem to find a goal.
    The argument fringe should be an empty queue.
    If two paths reach a state, only use the best one. [Fig. 3.18]"""
    closed = {}
...
def problema_ramificacion_y_acotacion_conH(problem):
    """Search the shallowest nodes in the search tree first. [p 74]"""
    return ramificacion_y_acotacion_conH(problem, SortedQueueHeur(problem))
